...
/* ══════════════════════════════════════
   FILE UPLOADER — defer to theme_engine
   (theme_engine.inject_design_system handles
   all uploader styling; only file-row remains here)
══════════════════════════════════════ */

/* Uploaded file row (filename + X dismiss button) */
